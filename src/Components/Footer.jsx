		...
		<footer class='bg-white dark:bg-gray-900'>
			<div class='grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4'>
				<div>
					<h2 class='mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400'>
						...
						12/65 กม 14 หมู่ 21 ซอย 117 ถนนรามอินทรา <br></br>แขวงมีนบุรี
						เขตมีนบุรี กรุงเทพมหานคร 10510
						<br></br>จันทร์-ศุกร์ เวลา 08:00-17:00,เสาร์ เวลา 08:00-17:00
						<br></br>
						0-2517-7227,0-2918-5463
					</h2>
			...
			<div class='py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between'>
				<span class='text-sm text-gray-500 dark:text-gray-300 sm:text-center'>
					© 2022 <a href='https://flowbite.com/'>SPCS™</a>. All Rights Reserved.
				</span>
