...
import TECH1 from "../team/Nuk.png";
  ...
  return (
    <div className="bg-[#FFFFFF]">
      <div className="container mx-auto">
        ...
        <div className="grid xl:grid-cols-6 grid-cols-1 mt-10 mb-10">
          <div className="text-center">
          ...
          <div className="text-center">
            <img src={TECH1} alt="" className="mx-auto w-[200px]"></img>
            <p className="mt-5 EngFont">Noramon Thiamtaveesin (Nuk)</p>
            <p className="EngFont">Software Engineer</p>
          </div>
          <div className="text-center">
